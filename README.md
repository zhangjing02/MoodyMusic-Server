...
> 更新时间：2026-09-18 | 集群总资产：11,649 首 | 总用量：54.47 GB / 80.00 GB (68.1%)

| 存储桶 | 物理名称 | 对象数 | 物理容量 | 水位 | 当前状态 |
| :--- | :--- | :---: | :---: | :---: | :--- |
| **Bucket 01** | `moody-music-asset` | 1,693 | 8.24 GB | 82.4% | ⬛ **永久只读封存** (FROZEN) |
| **Bucket 02** | `moody-music-asset-02` | 2,029 | **9.77 GB** | 97.7% | 🔴 **熔断封存** (FROZEN_READONLY) |
| **Bucket 03** | `moody-music-asset-03` | 2,100 | **9.65 GB** | 96.5% | 🔴 **熔断封存** (FROZEN_READONLY) |
| **Bucket 04** | `moody-music-asset-04` | 1,869 | 8.96 GB | 89.6% | 🟡 容量预警 (>80%) |
| **Bucket 05** | `moody-music-asset-05` | 1,923 | 8.95 GB | 89.5% | 🟡 容量预警 (>80%) |
| **Bucket 06** | `moody-music-asset-06` | 1,943 | 8.41 GB | 84.1% | 🟡 容量预警 (>80%) |
| **Bucket 07** | `moody-music-asset-07` | 92 | 0.48 GB | 4.8% | 🟢 **主力写入中** (ACTIVE) |
