...
"""
==============================================================================
MOODY - 曾轶可第二批次母带重制：《情绪禁区》与《2022》全专 25 首
==============================================================================
"""
...
BATCH_B_TASKS = [
    # === 情绪禁区 (10首) ===
    {"album": "情绪禁区", "id": 28842, "title": "彩虹", "nid": 1804555792},
    {"album": "情绪禁区", "id": 28843, "title": "雌雄同体", "nid": 1804552454},
    {"album": "情绪禁区", "id": 28844, "title": "水的记忆", "nid": 1804552456},
    {"album": "情绪禁区", "id": 28845, "title": "害羞", "nid": 1804555804},
    {"album": "情绪禁区", "id": 28846, "title": "Truly", "nid": 1804555812},
    {"album": "情绪禁区", "id": 28847, "title": "初吻", "nid": 1804552473},
    {"album": "情绪禁区", "id": 28848, "title": "昔日圣诞", "nid": 1804552474},
    {"album": "情绪禁区", "id": 28849, "title": "越界", "nid": 1804552475},
    {"album": "情绪禁区", "id": 28850, "title": "蝴蝶", "nid": 1804555814},
    {"album": "情绪禁区", "id": 28851, "title": "戏", "nid": 1804555815},
    
    # === 2022 (15首) ===
    {"album": "2022", "id": 28852, "title": "辣糖", "nid": 1966832809},
    {"album": "2022", "id": 28853, "title": "最天使", "nid": 1966832810},
    {"album": "2022", "id": 28854, "title": "女人的秘密", "nid": 1966826603},
    {"album": "2022", "id": 28855, "title": "夜车", "nid": 1966832811},
    {"album": "2022", "id": 28856, "title": "星星月亮", "nid": 1966832812},
    {"album": "2022", "id": 28857, "title": "白色秋天", "nid": 1966826604},
    {"album": "2022", "id": 28858, "title": "狮子座", "nid": 1966826605},
    {"album": "2022", "id": 28859, "title": "三的颜色", "nid": 1966832813},
    {"album": "2022", "id": 28860, "title": "勇敢一点", "nid": 1966832814},
    {"album": "2022", "id": 28861, "title": "还能孩子多久", "nid": 1966826606},
    {"album": "2022", "id": 28862, "title": "多余的流星", "nid": 1966832815},
    {"album": "2022", "id": 28863, "title": "新的家", "nid": 1966832816},
    {"album": "2022", "id": 28864, "title": "有可能的夜晚", "nid": 1966826607},
    {"album": "2022", "id": 28865, "title": "私奔", "nid": 1966832817},
    {"album": "2022", "id": 28866, "title": "我们不是只有现在吗", "nid": 1966832818}
]
...
def main():
    print("=" * 80, flush=True)
    print("🚀 曾轶可第二批次母带重制流水线: 《情绪禁区》 & 《2022》 (共 25 首)", flush=True)
    print("=" * 80, flush=True)
    
    success_items = []
    
    for idx, t in enumerate(BATCH_B_TASKS, 1):
        sid = t["id"]
        title = t["title"]
        album = t["album"]
        nid = t["nid"]
        
        print(f"\n[{idx:02d}/25] 🛠️ 重制《{album}》 - 《{title}》 (Song ID: {sid}, Netease: {nid})", flush=True)
    ...
    print("=" * 80, flush=True)
    print(f"🏁 第二批次重制完成! 成功: {len(success_items)} / {len(BATCH_B_TASKS)} 首", flush=True)
    print("=" * 80, flush=True)
