...
export const DEFAULT_THEME_STORIES: Record<string, ThemeStory> = {
  "pop_piano_theme": {
    ...
    "heroUrl": "https://m-api.changgepd.ccwu.cc/storage/covers/albums/pop_piano_cover.jpg",
    "bodyParagraphs": [
  ...
  "jonathan_lee_theme": {
    ...
    "heroUrl": "https://m-api.changgepd.ccwu.cc/storage/covers/albums/album_jonathan_lee.jpg",
    "bodyParagraphs": [
  ...
  "lofi_chill_theme": {
    ...
    "heroUrl": "https://pub-9ea7ff16135d47238c0229f1aa54ecc4.r2.dev/covers/albums/lofi_chill_cover.jpg",
    "bodyParagraphs": [
  ...
  "white_snake_flute_theme": {
    "themeId": "white_snake_flute_theme",
    "issueTag": "国风雅韵 · ISSUE #95",
    "categoryTag": "本 週 專 題 · 國 風 器 樂 · 竹 笛 清 響",
    "headline": "《青城山下白素贞：一管竹笛，吹尽人间千载情缘》",
    "subtitle": "全长 01 分 42 秒纯真声演绎 · 听灵动笛音穿透烟雨青翠",
    "authorDate": "左宏元 作曲   |   书领了吗 纯真声竹笛实录演绎",
    "heroUrl": "https://m-api.changgepd.ccwu.cc/storage/covers/albums/white_snake_flute_cover.jpg",
    "bodyParagraphs": [
      "【青城山下，一缕笛音破烟云】\n在中国传统吹管乐器中，竹笛最具‘灵性’与‘道骨’。一管苦竹，数枚竹节，经由演奏者的气息温润与指尖灵动，便能将东方文人寄托于山川灵秀的情思抒发得淋漓尽致。当《青城山下白素贞》那空灵悠扬的引子自竹管中悠然升起，青城山间缭绕的云雾、断桥旁飘洒的细雨、以及千年修持换来人间一顾的痴情执着，仿佛在眼前徐徐铺展。",
      "【器乐极简主义下的东方审美】\n不同于繁复铺陈的管弦交响，这版竹笛演绎褪去了华丽繁杂的音画修饰，专注于竹管本真的共鸣与气韵。演奏者‘书领了吗’以温润沉稳的气息控制，将白素贞初涉尘世时的纯净、报恩寻访时的期盼、以及水漫金山背后的坚贞，通过细致入微的揉音、滑音与吐音刻画入微。每一记气震音，都宛若青峰翠竹间轻掠的晨风，抚平心头的焦灼与浮躁。",
      "【以竹为骨，以清入神】\n笛音不仅是故事的讲述者，更是一剂抚慰现代人灵魂的东方降噪方。在喧嚣疲惫的都市节奏中闭上双眼，让这缕清越澄澈的笛声流淌于耳畔，如同置身于西湖烟柳之畔、青城古观之下，寻得片刻宁静致远的心灵栖所。"
    ],
    "quoteEn": "A flute of green bamboo plays the rain of Mount Qingcheng.\nThrough thousands of years of longing, only the purest breath remains.",
    "quoteZh": "“一管竹笛，吹散人间浮躁；千年痴恋，皆归指间清音。\n在快节奏的生活里，让这缕山野竹韵，带你重寻内心的宁静与诗意。”",
    "scenariosTitle": "🎧 适用场景 · Perfect for",
    "scenarios": [
      "• 静心品茗、习字作画：伴随着悠扬笛声，营造充满东方美学与禅意的雅致空间",
      "• 读书沉思、独处小憩：无歌词干扰的纯器乐清音，让紧绷的大脑自然放松",
      "• 阴雨天气、窗前放空：淅沥雨声与竹笛清音交融，感受诗意江南的烟雨朦胧",
      "• 睡前降噪、抚平焦虑：舒缓的气息流动与平稳节奏，引导身心步入宁静深呼吸"
    ],
    "benefitsTitle": "✨ 为什么这版竹笛演奏如此动人？",
    "benefits": [
      "✔  100% 真实原声吹奏：保留真实笛膜振动与指尖起落的呼吸感，纯净无人工合成杂质",
      "✔  纯正国风五声韵味：旋律婉转悠扬，完美契合传统东方听觉习惯与审美意趣",
      "✔  天然的身心降噪力：高频通透而不刺耳，中低频圆润丰满，极易引发深度共鸣与放松"
    ],
    "aboutTitle": "👉 关于作品与演绎者｜About Performer",
    "aboutDesc": "青年竹笛演奏者‘书领了吗’专注于传统吹管乐器与当代国风审美的融合探索，以扎实的传统功底与纯净自然的吹奏风格，用质朴温暖的音乐语言传递东方器乐的独特神韵。",
    "aboutMotto": "“愿这一曲清脆笛声，能带你穿过烟雨，遇见心底最纯净的宁静。”\n\n— Pure Bamboo, Pure Mind.",
    "footerSign": "左宏元 作曲 · 书领了吗 演奏   |   青城山下白素贞",
    "playPillTextActive": "竹笛演奏中 (01:42)",
    "playPillTextIdle": "聆听竹笛《青城山下白素贞》",
    "isSquareCover": false,
    "posterAspectRatio": 16.0,
    "timelineTitle": "",
    "timelineSections": []
  },
  "bach_cello_theme": {
    ...
    "heroUrl": "https://pub-9ea7ff16135d47238c0229f1aa54ecc4.r2.dev/covers/hero/bach_cello_hero.jpg",
    "bodyParagraphs": [
  ...
  "butterfly_lovers_deep_dive": {
    ...
    "heroUrl": "https://pub-9ea7ff16135d47238c0229f1aa54ecc4.r2.dev/covers/albums/butterfly_lovers_cover_clean.jpg",
    "bodyParagraphs": [
  ...
  "snow_cafe_theme": {
    ...
    "heroUrl": "https://pub-9ea7ff16135d47238c0229f1aa54ecc4.r2.dev/covers/hero/snow_cafe_hero.jpg",
    "bodyParagraphs": [
